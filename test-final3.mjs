...
async function test() {
    try {
        ...
        const res = await tt('https://www.tiktok.com/@mrbeast/video/7339097970729372974');
        console.log(JSON.stringify(res, null, 2));
    } catch(e) { console.error("tt err", e) }
    
    try {
        console.log("Insta fetch...");
        const client = new insta.default();
        const res = await client.post('https://www.instagram.com/reel/C3u2h7tJxwY/');
        console.log(JSON.stringify(res, null, 2));
